        ...
        btnRegis.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                edtPassword.getText().toString().isEmpty() || edtRePassword.getText().toString().isEmpty()){
                    Snackbar.make(view, "Seluruh Data Wajib diisi !!", Snackbar.LENGTH_LONG);
                }else{
                    if(edtPassword.getText().toString().equals(edtRePassword.getText().toString())){
                        Toast.makeText(getApplicationContext(), "Pendaftaran Berhasil", Toast.LENGTH_LONG);
                        Intent i =new Intent(getApplicationContext(),MainHomeActivity.class);
                        startActivity(i);
                    }else{
                        Snackbar.make(view, "Kedua password tidak sama", Snackbar.LENGTH_LONG);
                    }
                }
            }
        });
